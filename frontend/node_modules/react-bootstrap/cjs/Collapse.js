...
var Collapse = /*#__PURE__*/_react.default.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_TransitionWrapper.default, (0, _extends2.default)({
    ref: ref,
    ...
    children: function children(state, innerProps) {
      return /*#__PURE__*/_react.default.cloneElement(_children, (0, _extends2.default)({}, innerProps, {
        className: (0, _classnames.default)(className, _children.props.className, collapseStyles[state], computedDimension === 'width' && 'width')
      }));
    }
  }));
}); // @ts-ignore
