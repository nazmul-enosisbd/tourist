...
var Carousel = /*#__PURE__*/React.forwardRef(function (uncontrolledProps, ref) {
  ...
  var nextDirectionRef = (0, React.useRef)(null);

  var _useState = (0, React.useState)('next'),
  ...
  var _useState4 = (0, React.useState)(activeIndex || 0),
  ...
  var prev = (0, React.useCallback)(function (event) {
    if (isSliding) {
      return;
    }
  ...
  var handleEntered = (0, React.useCallback)(function () {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  var handleMouseOver = (0, React.useCallback)(function (event) {
    if (pause === 'hover') {
      setPaused(true);
    }
  ...
  var handleMouseOut = (0, React.useCallback)(function (event) {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  var touchStartXRef = (0, React.useRef)(0);
  var touchDeltaXRef = (0, React.useRef)(0);
  var touchUnpauseTimeout = (0, _useTimeout.default)();
  var handleTouchStart = (0, React.useCallback)(function (event) {
  ...
  var handleTouchMove = (0, React.useCallback)(function (event) {
  ...
  var handleTouchEnd = (0, React.useCallback)(function (event) {
    if (touch) {
  ...
  var intervalHandleRef = (0, React.useRef)();
  (0, React.useEffect)(function () {
  ...
  var indicatorOnClicks = (0, React.useMemo)(function () {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(Component, (0, _extends2.default)({
    ...
    children: [indicators && /*#__PURE__*/(0, _jsxRuntime.jsx)("ol", {
      className: prefix + "-indicators",
      children: (0, _ElementChildren.map)(children, function (_child, index) {
      ...
      children: (0, _ElementChildren.map)(children, function (child, index) {
        ...
        return slide ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_TransitionWrapper.default, {
          ...
          children: function children(status, innerProps) {
            return /*#__PURE__*/React.cloneElement(child, (0, _extends2.default)({}, innerProps, {
